  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.if %6 {
      ...
      scf.for %arg2 = %c0 to %c128 step %c1 {
        ...
        %40 = llvm.getelementptr %21[%39] : (!llvm.ptr, i32) -> !llvm.ptr, i8
        %41 = llvm.load %40 : !llvm.ptr -> i8
        %42 = llvm.getelementptr %20[%39] : (!llvm.ptr, i32) -> !llvm.ptr, i8
      ...
      scf.if %29 {
        ...
        %43 = memref.load %alloca_1[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
        %44 = func.call @ncclAllGather(%41, %41, %c0_i64, %c2_i32, %42, %43) : (memref<?xi8>, memref<?xi8>, i64, i32, memref<?x!llvm.struct<()>>, memref<?x!llvm.struct<()>>) -> i32
      }
      %30 = memref.load %alloca_1[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
      %31 = func.call @cudaStreamSynchronize(%30) : (memref<?x!llvm.struct<()>>) -> i32
      ...
      %35 = func.call @cudaFree(%34) : (memref<?xi8>) -> i32
      %36 = memref.load %alloca_3[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
      %37 = func.call @ncclCommDestroy(%36) : (memref<?x!llvm.struct<()>>) -> i32
      %38 = func.call @MPI_Finalize() : () -> i32
    }
    return %8 : i32
  }
