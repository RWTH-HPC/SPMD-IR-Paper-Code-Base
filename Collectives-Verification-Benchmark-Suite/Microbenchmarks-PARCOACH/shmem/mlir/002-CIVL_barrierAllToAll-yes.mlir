module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %7 = call @shmem_malloc(%3) : (i64) -> memref<?xi8>
    %8 = "polygeist.memref2pointer"(%7) : (memref<?xi8>) -> !llvm.ptr
    %9 = "polygeist.pointer2memref"(%8) : (!llvm.ptr) -> memref<?xi32>
    ...
    scf.if %10 {
      ...
      scf.for %arg2 = %c0 to %11 step %c1 {
        ...
        %16 = arith.subi %0, %15 : i32
        %17 = llvm.getelementptr %5[%15] : (!llvm.ptr, i32) -> !llvm.ptr, i32
        llvm.store %16, %17 : i32, !llvm.ptr
      }
      %12 = memref.get_global @SHMEM_TEAM_WORLD : memref<1xmemref<?x1xi32>>
      %13 = memref.load %12[%c0] : memref<1xmemref<?x1xi32>>
      %14 = func.call @shmem_int_alltoall(%13, %9, %6, %c1_i64) : (memref<?x1xi32>, memref<?xi32>, memref<?xi32>, i64) -> i32
      func.call @shmem_sync_all() : () -> ()
    } else {
      func.call @shmem_sync_all() : () -> ()
      %11 = memref.get_global @SHMEM_TEAM_WORLD : memref<1xmemref<?x1xi32>>
      %12 = memref.load %11[%c0] : memref<1xmemref<?x1xi32>>
      %13 = func.call @shmem_int_alltoall(%12, %9, %6, %c1_i64) : (memref<?x1xi32>, memref<?xi32>, memref<?xi32>, i64) -> i32
      %14 = llvm.mlir.addressof @str0 : !llvm.ptr
      %15 = llvm.getelementptr %14[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<24 x i8>
      %16 = llvm.load %8 : !llvm.ptr -> i32
      %17 = llvm.call @printf(%15, %1, %16) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32) -> i32
    }
    call @shmem_free(%4) : (memref<?xi8>) -> ()
    call @shmem_free(%7) : (memref<?xi8>) -> ()
    call @shmem_finalize() : () -> ()
    return %c0_i32 : i32
  }
  ...
  func.func private @shmem_int_alltoall(memref<?x1xi32>, memref<?xi32>, memref<?xi32>, i64) -> i32 attributes {llvm.linkage = #llvm.linkage<external>}
