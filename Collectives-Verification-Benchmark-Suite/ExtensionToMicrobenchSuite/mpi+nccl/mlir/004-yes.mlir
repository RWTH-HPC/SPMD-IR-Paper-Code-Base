module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.if %5 {
      %52 = func.call @ncclGetUniqueId(%cast) : (memref<?x!llvm.struct<(array<128 x i8>)>>) -> i32
    }
    ...
    %20 = call @cudaStreamCreate(%cast_15) : (memref<?xmemref<?x!llvm.struct<()>>>) -> i32
    %cast_16 = memref.cast %alloca_4 : memref<1xmemref<?x!llvm.struct<()>>> to memref<?xmemref<?x!llvm.struct<()>>>
    %21 = memref.load %alloca_7[%c0] : memref<1xi32>
    %22 = "polygeist.memref2pointer"(%alloca) : (memref<1x!llvm.struct<(array<128 x i8>)>>) -> !llvm.ptr
    scf.for %arg2 = %c0 to %c128 step %c1 {
      %52 = arith.index_cast %arg2 : index to i32
      %53 = llvm.getelementptr %6[%52] : (!llvm.ptr, i32) -> !llvm.ptr, i8
      %54 = llvm.load %53 : !llvm.ptr -> i8
      %55 = llvm.getelementptr %22[%52] : (!llvm.ptr, i32) -> !llvm.ptr, i8
      llvm.store %54, %55 : i8, !llvm.ptr
    }
    %23 = memref.load %alloca_8[%c0] : memref<1xi32>
    %24 = memref.load %alloca[%c0] : memref<1x!llvm.struct<(array<128 x i8>)>>
    %25 = call @ncclCommInitRank(%cast_16, %21, %24, %23) : (memref<?xmemref<?x!llvm.struct<()>>>, i32, !llvm.struct<(array<128 x i8>)>, i32) -> i32
    %26 = memref.load %alloca_4[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
    %cast_17 = memref.cast %alloca_0 : memref<1xi32> to memref<?xi32>
    %27 = call @ncclCommUserRank(%26, %cast_17) : (memref<?x!llvm.struct<()>>, memref<?xi32>) -> i32
    %28 = memref.load %alloca_0[%c0] : memref<1xi32>
    ...
    scf.if %29 {
      ...
      %58 = memref.load %alloca_4[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
      %59 = memref.load %alloca_1[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
      %60 = func.call @ncclReduce(%54, %57, %c1_i64, %c2_i32, %c0_i32, %c0_i32, %58, %59) : (memref<?xi8>, memref<?xi8>, i64, i32, i32, i32, memref<?x!llvm.struct<()>>, memref<?x!llvm.struct<()>>) -> i32
      %61 = "polygeist.memref2pointer"(%alloca_6) : (memref<1xi32>) -> !llvm.ptr
      %62 = "polygeist.pointer2memref"(%61) : (!llvm.ptr) -> memref<?xi8>
      %63 = func.call @MPI_Bcast(%62, %c1_i32, %c1275069445_i32, %c0_i32, %c1140850688_i32) : (memref<?xi8>, i32, i32, i32, i32) -> i32
    } else {
      %52 = "polygeist.memref2pointer"(%alloca_6) : (memref<1xi32>) -> !llvm.ptr
      %53 = "polygeist.pointer2memref"(%52) : (!llvm.ptr) -> memref<?xi8>
      %54 = func.call @MPI_Bcast(%53, %c1_i32, %c1275069445_i32, %c0_i32, %c1140850688_i32) : (memref<?xi8>, i32, i32, i32, i32) -> i32
      %55 = memref.load %alloca_3[%c0] : memref<1xmemref<?xi32>>
      %56 = "polygeist.memref2pointer"(%55) : (memref<?xi32>) -> !llvm.ptr
      %57 = "polygeist.pointer2memref"(%56) : (!llvm.ptr) -> memref<?xi8>
      ...
      %61 = memref.load %alloca_4[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
      %62 = memref.load %alloca_1[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
      %63 = func.call @ncclReduce(%57, %60, %c1_i64, %c2_i32, %c0_i32, %c0_i32, %61, %62) : (memref<?xi8>, memref<?xi8>, i64, i32, i32, i32, memref<?x!llvm.struct<()>>, memref<?x!llvm.struct<()>>) -> i32
    }
    %30 = memref.load %alloca_3[%c0] : memref<1xmemref<?xi32>>
    %31 = "polygeist.memref2pointer"(%30) : (memref<?xi32>) -> !llvm.ptr
    ...
    %36 = memref.load %alloca_4[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
    %37 = memref.load %alloca_1[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
    %38 = call @ncclReduceScatter(%32, %35, %c0_i64, %c2_i32, %c0_i32, %36, %37) : (memref<?xi8>, memref<?xi8>, i64, i32, i32, memref<?x!llvm.struct<()>>, memref<?x!llvm.struct<()>>) -> i32
    ...
    %49 = memref.load %alloca_4[%c0] : memref<1xmemref<?x!llvm.struct<()>>>
    %50 = call @ncclCommDestroy(%49) : (memref<?x!llvm.struct<()>>) -> i32
    %51 = call @MPI_Finalize() : () -> i32
    return %c0_i32 : i32
  }
