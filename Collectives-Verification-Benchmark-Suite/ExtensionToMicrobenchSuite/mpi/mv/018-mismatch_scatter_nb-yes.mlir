module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic", spmd.executionKind = "All"} {
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>, spmd.executionKind = "All"} {
    ...
    memref.store %2, %alloca_1[%c0] {spmd.executionKind = "All"} : memref<1xi32>
    ...
    %4 = arith.index_cast %size {spmd.executionKind = "All"} : i32 to index
    %alloca_3 = memref.alloca(%4) {spmd.executionKind = "All"} : memref<?xi32>
    %5 = arith.cmpi eq, %rank, %c0_i32 {spmd.executionKind = "All"} : i32
    scf.if %5 {
      scf.for %arg2 = %c0 to %4 step %c1 {
        %9 = arith.index_cast %arg2 {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : index to i32
        memref.store %9, %alloca_3[%arg2] {spmd.executedBy = array<i32: 0>, spmd.executionKind = "Static"} : memref<?xi32>
    ...
    scf.if %7 {
      ...
      %11 = "polygeist.memref2pointer"(%alloca_1) {spmd.executionKind = "Dynamic"} : (memref<1xi32>) -> !llvm.ptr
      ...
      %error_4 = "spmd.scatter"(%1, %10, %13, %0, %12, %c1_i64, %0, %c0_i32) <{isBlocking = true, usedModel = 0 : i32}> {spmd.executionKind = "Dynamic"} : (!spmd.comm, memref<?xi8>, i64, !spmd.datatype, memref<?xi8>, i64, !spmd.datatype, i32) -> !spmd.error
    } else {
      %9 = "polygeist.memref2pointer"(%alloca_3) {spmd.executionKind = "Dynamic"} : (memref<?xi32>) -> !llvm.ptr
      %10 = "polygeist.pointer2memref"(%9) {spmd.executionKind = "Dynamic"} : (!llvm.ptr) -> memref<?xi8>
      %11 = "polygeist.memref2pointer"(%alloca_1) {spmd.executionKind = "Dynamic"} : (memref<1xi32>) -> !llvm.ptr
      %12 = "polygeist.pointer2memref"(%11) {spmd.executionKind = "Dynamic"} : (!llvm.ptr) -> memref<?xi8>
      %13 = arith.extui %size {spmd.executionKind = "Dynamic"} : i32 to i64
      %req, %error_4 = "spmd.scatter"(%1, %10, %13, %0, %12, %c1_i64, %0, %c0_i32) <{isBlocking = false, usedModel = 0 : i32}> {spmd.executionKind = "Dynamic"} : (!spmd.comm, memref<?xi8>, i64, !spmd.datatype, memref<?xi8>, i64, !spmd.datatype, i32) -> (!spmd.req, !spmd.error)
